                                        ...
                                        <div class="product-item">
                                            <div class="product-img">
                                                <a href="single-product.html">
                                                    <?=\yii\helpers\Html::img("@web/img/products/{$product->img_src}",['alt'=>$product->name])?>
                                                </a>
                                            </div>
                                            <div class="product-info">
                                                <h6 class="product-title">
                                                    <a href="<?=\yii\helpers\Url::to(['/products/view'])?>"><?=$product->name?></a>
                                                </h6>
                                            ...
                                            if($product->rating>0):?>
                                                ...
                                                <ul class="action-button">
                                                    ...
                                                    <li id="liModal">
                                                        <a href="<?php \yii\helpers\Url::to(['products/modal','id'=>$product->id])?>" id="modalProduct" data-toggle="modal"  data-target="#productModal" data-id="<?=$product->id?>" title="Quickview"><i class="zmdi zmdi-zoom-in"></i></a>
                                                    </li>
                                                    <li>
                ...
                <div class="col-md-3 col-md-pull-9 col-sm-12">
                    ...
                    <aside class="widget widget-categories box-shadow mb-30">
                        ...
                        <div id="cat-treeview" class="product-cat">
                            <ul>
                            <?php echo \app\components\MyWidget::widget(['tpl'=>'menu']); ?>
                            </ul>
                        </div>
                    </aside>
                    <!-- shop-filter -->
